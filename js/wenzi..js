...
const CNP1 = document.getElementById('CNP1')
const CNP2 = document.getElementById('CNP2')
const CNP3 = document.getElementById('CNP3')
const CNP4 = document.getElementById('CNP4')
const CNP5 = document.getElementById('CNP5')
const CNP6 = document.getElementById('CNP6')
const CNP7 = document.getElementById('CNP7')
b.onclick=()=>{
    setTimeout(() => {
        CNP1.style.opacity = 1
        CNP1.style.transition = 'all 1s linear'
        setTimeout(CNP2Show, 1200)
    }, 1200)
}
CNP2Show = () => {
    CNP2.style.opacity = 1
    CNP2.style.transition = 'all 1s linear'
    setTimeout(CNP3Show, 1200)
}
CNP3Show = () => {
    CNP3.style.opacity = 1
    CNP3.style.transition = 'all 1s linear'
    setTimeout(CNP4Show, 1200)
}
CNP4Show = () => {
    CNP4.style.opacity = 1
    CNP4.style.transition = 'all 1s linear'
    setTimeout(CNP5Show, 1200)
}
CNP5Show = () => {
    CNP5.style.opacity = 1
    CNP5.style.transition = 'all 1s linear'
    setTimeout(NP6Show, 1200)
}
NP6Show = () => {
    CNP6.style.opacity = 1
    CNP6.style.transition = 'all 1s linear'
    setTimeout(CNP7Show, 1200)
}
CNP7Show = () => {
    CNP7.style.opacity = 1
    CNP7.style.transition = 'all 1s linear'
    setTimeout(CNP3Show, 1200)
}